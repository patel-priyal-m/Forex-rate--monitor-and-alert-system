...
class TestRatesEndpoint:
    ...
    def test_get_rates_with_pair_filter(self, test_client):
        ...
        assert isinstance(data, list)
        # If data exists, verify it's filtered correctly
        for item in data:
            assert item["pair"] == "USD/EUR"
    ...
    def test_get_rate_history_invalid_pair(self, test_client):
        ...
        # Should still return 200 with empty list or handle gracefully
...
class TestAlertsEndpoint:
    ...
    def test_create_alert_invalid_threshold(self, test_client):
        ...
        # If 200, the system should handle it gracefully
    ...
    def test_get_alerts(self, test_client, sample_alert):
        ...
        test_client.post("/alerts", json=sample_alert)
    ...
    def test_get_alerts_with_pair_filter(self, test_client, sample_alert):
        ...
        for alert in data:
            assert alert["pair"] == sample_alert["pair"]
    ...
    def test_get_alerts_history(self, test_client):
        """Test retrieving alert trigger history."""
        ...
        for item in data:
            if len(data) > 0:  # Only check if there's data
